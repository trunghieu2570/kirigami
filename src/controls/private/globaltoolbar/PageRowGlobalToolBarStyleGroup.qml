...
QtObject {
    ...
    readonly property int actualStyle: {
        if (style === Kirigami.ApplicationHeaderStyle.Auto) {
            ...
            //non legacy logic
            return (Kirigami.Settings.isMobile ? (root.wideMode ? Kirigami.ApplicationHeaderStyle.Titles : Kirigami.ApplicationHeaderStyle.Breadcrumb) : Kirigami.ApplicationHeaderStyle.ToolBar);
        }
        return style;
    }
    ...
    property int preferredHeight: (actualStyle === Kirigami.ApplicationHeaderStyle.ToolBar ? Kirigami.Units.iconSizes.medium : Kirigami.Units.gridUnit * 1.8) + Kirigami.Units.smallSpacing * 2
