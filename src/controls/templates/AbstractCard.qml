...
//BEGIN signal handlers
    ...
    onFooterChanged: {
        ...
        footer.anchors.topMargin = Qt.binding(function() {return (root.height - root.bottomPadding - root.topPadding - root.topInset - root.bottomInset)  - (footerParent.y + footerParent.height)});
    }
