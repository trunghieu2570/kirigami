...
T.Dialog {
     ...
     * and bottom.
     */
    readonly property real absoluteMaximumHeight: 400 // parent.parent.height - Kirigami.Units.largeSpacing * 2
     ...
     * the top and bottom.
     */
    readonly property real absoluteMaximumWidth: 400 // parent.parent.width - Kirigami.Units.largeSpacing * 2
     ...
     */
    property real maximumHeight: 400 // absoluteMaximumHeight
     ...
     */
    property real maximumWidth: 400 // absoluteMaximumWidth
    ...
    contentItem: ColumnLayout {
        Private.ScrollView {
            ...
            onCalculatedMaximumHeightChanged: console.log(contentControl.Layout.maximumHeight, root.maximumWidth, root.absoluteMaximumWidth)
            onCalculatedImplicitHeightChanged: console.log(root.mainItem.implicitHeight)
